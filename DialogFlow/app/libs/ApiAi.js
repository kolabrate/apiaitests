...
var Request = (function () {
    function Request(apiAiClient, options,fromNum,query) {
        ...
        this.options.originalRequest = {
            "source": "Portal Testing Test",
            "data": {
                "ApiVersion": "",
                "SmsSid": "",
                "SmsStatus": "",
                ...
                "ToState": "",
                "From": fromNum,
                "MessageSid": "SMf0000000000000000000000",
                "AccountSid": "",
                "ToCity": "",
                "FromCountry": "",
                "ToZip": "",
...
var ApiAiClient = (function () {
    ...
    ApiAiClient.prototype.textRequest = function (query,fromNum, options) {
        if (options === void 0) { options = {}; }
        if (!query) {
            throw new Errors_1.ApiAiClientConfigurationError("Query should not be empty");
        }
        options.query = query;
        //options.originalRequest.data.From = fromNum;
        //options.originalRequest.data.Body = query;
        return new TextRequest_1.default(this, options, fromNum, query).perform();
    };
